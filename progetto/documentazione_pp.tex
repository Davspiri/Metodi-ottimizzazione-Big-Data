...
\noindent §§BOXSTART§definbox§§

\textbf{$f_1$ — Dispersione della rete (coesione mesh)}
...
\textbf{$f_2$ — Distanza dalle stazioni fisse}
...
\textbf{$f_3$ — Deviazione dalla distanza operativa ideale}
...
\textbf{$f_4$ — Costo ambientale black-box}
...
\noindent §§BOXSTART§thmbox§§

\textbf{Condizioni necessarie del primo ordine}
...
\textbf{Condizioni necessarie del secondo ordine}
...
\textbf{Partizionamento in blocchi}
...
\textbf{BCD Gauss-Seidel (variante ciclica)}
...
\textbf{Schema di stepsize decrescente}
...
\textbf{Condizioni sufficienti per la convergenza (Teorema di convergenza)}
...
\textbf{Teorema di convergenza RBCD — Gauss-Seidel (da slide del corso)}
...
§§CAP§Righe 1–61 — Header, import e costanti§§
...
§§CAP§Righe 37–43 — Import delle librerie§§
...
§§CAP§Righe 45–61 — Costanti del problema§§
...
§§CAP§Righe 68–78 — Scrittura file e chiamata al simulatore§§
...
§§CAP§Righe 81–125 — Worker function e calcolo parallelo del gradiente di $f_4$§§
...
§§CAP§Righe 132–153 — $f_1$, $f_2$, $f_3$ e loro somma§§
...
§§CAP§Righe 160–179 — Gradienti parziali di $f_1$, $f_2$, $f_3$ per il blocco $i$§§
...
§§CAP§Righe 186–201 — Inizializzazione con $f_3 = 0$§§
...
§§CAP§Righe 208–268 — Firma funzione e inizializzazione§§
...
§§CAP§Righe 230–256 — Inizializzazione e prima valutazione§§
...
§§CAP§Righe 269–290 — Loop principale: un'epoca§§
...
§§CAP§Righe 292–311 — Fine epoca: valutazione, log e checkpointing§§
...
§§CAP§Righe 363–391 — Entry point con le tre modalità§§
...
\textbf{Convergenza del RBCD Gauss-Seidel con stepsize decrescente}
